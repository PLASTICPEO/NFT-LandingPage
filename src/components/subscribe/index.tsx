...
const SubscribeComponent = () => {
  ...
  return (
    <motion.div
      className="flex items-center justify-center relative w-full h-96 container mx-auto my-10"
      variants={slideCotainerVariant}
      initial="hidden"
      whileInView="visible"
    >
      <div className="absolute top-0 left-0 w-[1px] h-1/2 bg-gradient-to-b from-[#A8189A] rounded-b-lg opacity-90"></div>
      <div className="absolute top-0 left-0 w-1/2 h-[1px] bg-gradient-to-r from-[#A8189A] rounded-b-lg opacity-90"></div>
      <div className="absolute bottom-0 right-0 w-[1px] h-1/2 bg-gradient-to-t  from-green-800 rounded-t-lg opacity-90"></div>
      <div className="absolute bottom-0 right-0 w-1/2 h-[1px] bg-gradient-to-l from-green-800 rounded-t-lg opacity-90"></div>
        ...
        <div className="flex items-center justify-center space-x-2">
          <div className="relative">
            <input
              ...
              className="text-[#FFFFFF]/85 px-2.5 font-Poppins text-sm h-8 outline-none m-1.5 placeholder-gray-900 placeholder:Roboto placeholder:text-xl placeholder:text-[#FFFFFF]/55  bg-transparent xl:w-72 w-44"
              type="text"
              name="email"
